    function calcKm(){
      ...
      const mptSample=mptCars[0]||null;
        ...
        <div class="km-layout">
          ...
          <div class="km-right">
            ${useLoan?`<div class="card">
              ...
              <p class="calc-note">ПВ от цены авто ${rub(price)} ₽, без Д/О и каско. В кредит входят авто − ПВ, Д/О, каско расширенное и комиссия банка.${showSplit?" Справа МПТ: цена аналога с флит и МПТ −10%, трейд-ин как слева, только Совкомбанк 19,2%.":showMpt?" По этой комплектации в наличии есть МПТ.":""}${pickMpt?" Выбран VIN с меткой МПТ.":""}</p>
              ...
              <p class="calc-note">${rub(down)} ₽ · ${downPct}% от цены авто${showMpt?` · МПТ: ${rub(priceMpt)} − ПВ в авто ${rub(downMptCar)} = тело ${rub(creditMpt)}`:""}</p>
